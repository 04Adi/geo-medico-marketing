...
export default function App() {
  ...
  const [page, setPage] = useState('home')   // 'home' | 'fortis-pod' | 'admin'

  if (page === 'admin') {
    return <AdminPage onBack={() => { setPage('home'); window.scrollTo(0, 0) }} />
  }
  ...
  if (page === 'fortis-pod') {
    return (
      <>
        ...
        <Footer onAdmin={() => { setPage('admin'); window.scrollTo(0, 0) }} />
      </>
    )
  }
